...
class SvgImage(SvgFragmentImage):
    ...
    def __init__(self, border, width, box_size):
        super(SvgImage, self).__init__(border, width*10, box_size)
    ...
    def _rect(self, row, col):
        return super(SvgImage, self)._rect(row*10, col*10, tag="rect")
